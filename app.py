...
def return_dict():
    ...
    dict_here = [
        ...
        {'id': 4, 'name': 'Novel', 'link': 'music/novel_song.wav', 'genre': 'Electronic XD'},
        {'id': 5, 'name': 'Novel1', 'link': 'music/novel_song1.wav', 'genre': 'Electronic XD'},
        {'id': 6, 'name': 'Novel2', 'link': 'music/novel_song2.wav', 'genre': 'Electronic XD'},
        {'id': 7, 'name': 'Novel3', 'link': 'music/novel_song3.wav', 'genre': 'Electronic XD'},
        {'id': 8, 'name': 'Novel4', 'link': 'music/novel_song4.wav', 'genre': 'Electronic XD'},
        {'id': 9, 'name': 'Novel5', 'link': 'music/novel_song5.wav', 'genre': 'Electronic XD'},
        ]
    return dict_here
